...
items = {}
info = {'my_id':None, 'my_ip':'192.168.1.4:5001', 'prev_id':None, 'next_id':None, 'prev_ip':None, 'next_ip':None, 'my_replica_id':None}
...
if __name__ == '__main__':
	app.run(host='192.168.1.4', port=5001, debug = False)
